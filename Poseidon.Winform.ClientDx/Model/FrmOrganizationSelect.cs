...
namespace Poseidon.Winform.ClientDx
{
    ...
    public partial class FrmOrganizationSelect : BaseSingleForm
    {
        ...
        protected override void InitForm()
        {
            ...
            this.bsModelType.DataSource = CallerFactory<IModelTypeService>.Instance.FindWithCodes(this.currentGroup.ModelTypes).Where(r => r.Category == (int)ModelCategory.Organization);
